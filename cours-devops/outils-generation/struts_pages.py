...
d = sys.argv[1]
page('cours-04-struts-hibernate-jsp.html', 'Struts, Hibernate et JSP — de zéro à expert', "Douze chapitres pour maîtriser le web Java classique et son legacy : Servlets et JSP (EL, JSTL, tags, Tiles, i18n, sécurité), Struts 2/6 (architecture, actions, validation, OGNL, intercepteurs, plugins, sécurité S2-xxx), Struts 1 et sa migration, Hibernate 6 (mapping, cycle de vie, associations, N+1, JPQL/Criteria, transactions, verrous, caches, Spring Data, Flyway, Envers, multi-tenant), projet complet et 40 questions d'entretien. Tout en Docker (Maven, Tomcat, PostgreSQL), chaque chapitre a ses exercices corrigés et un travail pratique avec correction type.", "≈ 50 h de travail · prérequis : Java confirmé, notions de SQL, Docker Desktop · complète le cours PostgreSQL du niveau 8 (TP 47) et le cours Java PKI pour la sécurité.", SH, [('cours-06-java-pki-signature-electronique.html', 'Java PKI'), ('cours-15-data-platform-aws-talend.html', 'Data Platform'), ('devops-07-securite-devsecops.html', 'DevOps niveau 7')])
