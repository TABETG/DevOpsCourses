...
d = sys.argv[1]
page('cours-java-pki-signature-electronique.html', 'Java, PKI et signature électronique — de zéro à expert', "Treize chapitres orientés mission et entretien : cryptographie appliquée, PKI et X.509, formats, keystores et Spring Boot, TLS/mTLS, signature électronique (CAdES/XAdES/PAdES, horodatage), Java et Bouncy Castle, application Spring Boot de signature, validation et révocation, eIDAS et RGS, architecture avec HSM, sécurité et débogage, 40 questions d'entretien et fiche de révision. Tout en Docker (OpenSSL, JDK, Maven, SoftHSM2), chaque chapitre a ses exercices corrigés et un travail pratique avec correction type.", "≈ 40 h de travail · prérequis : Java/Spring Boot confirmé, Docker Desktop · complète le niveau 7 du parcours DevOps (PKI 41.9, Vault PKI, cert-manager).", PKI, [('cours-cloud.html', 'Cloud'), ('devops-niveau-7-securite-devsecops.html', 'DevOps niveau 7')])
