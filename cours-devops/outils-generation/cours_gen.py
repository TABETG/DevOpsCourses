"""Génère cours-03-vue.html, cours-07-cloud.html et régénère cours-01-react.html / cours-02-angular.html avec un chapitre 11 expert.
...
if __name__ == '__main__':
    page('cours-01-react.html', 'React — de zéro à expert', "Onze chapitres pour maîtriser React 19 avec TypeScript : composants, état, effets, données serveur, état global (stores, atomes, signals), formulaires, tests, production, puis l'échelle (monorepo, rendu concurrent, micro-frontends, observabilité). Projet fil conducteur : le front de CrisisShield. Tout tourne en Docker, chaque chapitre a ses exercices corrigés et un travail pratique avec correction type.", "≈ 45 h de travail · prérequis : Docker Desktop, notions de HTML/CSS · voir aussi les cours <a href=\"cours-02-angular.html\" style=\"color:#fff\">Angular</a> et <a href=\"cours-03-vue.html\" style=\"color:#fff\">Vue</a> pour comparer les trois modèles de réactivité.", REACT, ('cours-02-angular.html', 'Cours Angular'))
    page('cours-02-angular.html', 'Angular — de zéro à expert', "Onze chapitres pour maîtriser Angular 19/20 : composants standalone, signals (signal, computed, effect, linkedSignal, resource), injection de dépendances, routage, formulaires typés, NgRx SignalStore, tests, SSR, production, puis l'échelle (Nx, micro-frontends, CDK, Web Components, migrations). Projet fil conducteur : le front de CrisisShield. Tout tourne en Docker, chaque chapitre a ses exercices corrigés et un travail pratique avec correction type.", "≈ 45 h de travail · prérequis : Docker Desktop, notions de HTML/CSS · voir aussi les cours <a href=\"cours-01-react.html\" style=\"color:#fff\">React</a> et <a href=\"cours-03-vue.html\" style=\"color:#fff\">Vue</a>.", ANG, ('cours-03-vue.html', 'Cours Vue'))
    page('cours-03-vue.html', 'Vue.js — de zéro à expert', "Dix chapitres pour maîtriser Vue 3 avec TypeScript : composants monofichiers, réactivité (ref, reactive, computed, watch — les signals de Vue), Composition API et composables, Vue Router, Pinia, formulaires (VeeValidate + Zod), tests, Nuxt et production. Projet fil conducteur : le front de CrisisShield. Tout tourne en Docker, chaque chapitre a ses exercices corrigés et un travail pratique avec correction type.", "≈ 40 h de travail · prérequis : Docker Desktop, notions de HTML/CSS · voir aussi les cours <a href=\"cours-01-react.html\" style=\"color:#fff\">React</a> et <a href=\"cours-02-angular.html\" style=\"color:#fff\">Angular</a> : même projet, trois modèles de réactivité.", VUE, ('cours-01-react.html', 'Cours React'))
    page('cours-07-cloud.html', 'Cloud — de zéro à expert', "Dix chapitres pour maîtriser le cloud avec AWS comme référence et les équivalents Azure et GCP : compte et identité, réseau, calcul (ECS, EKS, Lambda), données, serverless et événementiel, observabilité et sécurité, IaC et landing zone, multi-cloud et souveraineté, FinOps, Well-Architected, migration et certifications. Tout en Terraform depuis un conteneur, sur un compte sandbox détruit après chaque TP (ou LocalStack). Ce cours approfondit le niveau 4 du parcours DevOps et renvoie aux TP existants.", "≈ 50 h de travail · prérequis : niveaux 0 à 3 du parcours DevOps (Docker, Git, Terraform) · coût : quelques euros de sandbox AWS, tout est détruit en fin de TP · voir le <a href=\"devops-04-cloud.html\" style=\"color:#fff\">niveau 4</a> pour l'introduction.", CLOUD, ('devops-04-cloud.html', 'Niveau 4 — Cloud'))
